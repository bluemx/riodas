<template>
 <div :class="['w-full p-1 rounded flex flex-col justify-center items-center !h-auto relative border-solid', blocks.resultClass.value ]"  ref="block">
    ...
    <div class="text-xs ml-auto w-full text-right text-neutral/30">

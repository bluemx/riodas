...
<div ref="block" :blockindex="blockindex" class="dragzone relative rounded p-1 border-2 border-dashed border-slate-400 min-w-[80px] min-h-[60px]" :class="[ data.class || '' ]">  </div>
